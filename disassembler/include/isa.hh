    ...
    std::map<unsigned char, std::pair<std::string, std::vector<AddressingModeFamily>>> isa =
        {
            ...
            {0x3E, {"ldsr",    {REGISTER_ACCESS, MEMORY_RELATED}}},
            {0x3F, {"ldsp",    {REGISTER_ACCESS, MEMORY_RELATED}}},
            {0x40, {"ldbp",    {REGISTER_ACCESS, MEMORY_RELATED}}},
            ...
            {0x60, {"time",    {MEMORY_RELATED, REGISTER_ACCESS}}},
            {0x61, {"tstart",  {IMPLIED}}},
            {0x62, {"tstop",   {IMPLIED}}},
